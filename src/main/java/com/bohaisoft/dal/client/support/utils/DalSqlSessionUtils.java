...
/**
 * Created by liuhb on 2017/8/22.
 */
public class DalSqlSessionUtils {


    private static final Log logger = LogFactory.getLog(DalSqlSessionUtils.class);

    /**
     * This class can't be instantiated, exposes static utility methods only.
     */
    private DalSqlSessionUtils() {
        // do nothing
    }
